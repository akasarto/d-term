...
{
	public class OnWindowRendered
	{
		public static readonly DependencyProperty CallMethodProperty = DependencyProperty.RegisterAttached("CallMethod", typeof(string), typeof(OnWindowRendered), new PropertyMetadata(null, OnCallMethodPropertyChanged));
