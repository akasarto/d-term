...
namespace dTerm.UI.Wpf.Infrastructure
{
	...
	{
		public IConsoleInstance Create(string consoleName, ConsoleType consoleType, ConsoleProcessStartInfo consoleProcessStartInfo, int operationsTimeoutInSecconds = 5)
		{
