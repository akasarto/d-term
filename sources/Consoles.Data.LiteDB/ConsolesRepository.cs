		...
		public List<ConsoleEntity> GetAll()
		{
			return new List<ConsoleEntity>()
			{
				new ConsoleEntity() {
					...
					Index = 1,
					Name = "Command Prompt",
					IconPath = "M20,19V7H4V19H20M20,3A2,2 0 0,1 22,5V19A2,2 0 0,1 20,21H4A2,2 0 0,1 2,19V5C2,3.89 2.9,3 4,3H20M13,17V15H18V17H13M9.58,13L5.57,9H8.4L11.7,12.3C12.09,12.69 12.09,13.33 11.7,13.72L8.42,17H5.59L9.58,13Z",
					ProcessPathBuilder = PathBuilder.SystemPathVar,
					ProcessPathExeFilename = @"/cmd.exe",
					ProcessPathExeStartupArgs = string.Empty,
				...
				new ConsoleEntity() {
					...
					Index = 2,
					Name = "Git Bash",
					IconPath = "M2.6,10.59L8.38,4.8L10.07,6.5C9.83,7.35 10.22,8.28 11,8.73V14.27C10.4,14.61 10,15.26 10,16A2,2 0 0,0 12,18A2,2 0 0,0 14,16C14,15.26 13.6,14.61 13,14.27V9.41L15.07,11.5C15,11.65 15,11.82 15,12A2,2 0 0,0 17,14A2,2 0 0,0 19,12A2,2 0 0,0 17,10C16.82,10 16.65,10 16.5,10.07L13.93,7.5C14.19,6.57 13.71,5.55 12.78,5.16C12.35,5 11.9,4.96 11.5,5.07L9.8,3.38L10.59,2.6C11.37,1.81 12.63,1.81 13.41,2.6L21.4,10.59C22.19,11.37 22.19,12.63 21.4,13.41L13.41,21.4C12.63,22.19 11.37,22.19 10.59,21.4L2.6,13.41C1.81,12.63 1.81,11.37 2.6,10.59Z",
					ProcessPathBuilder = PathBuilder.ProgramFilesFolder,
					ProcessPathExeFilename = @"/git/bin/sh.exe",
					ProcessPathExeStartupArgs = "--login -i",
					UTCCreation = DateTime.UtcNow
				},
