...
namespace Win32Api
{
	public static class User32Methods
	{
		...
		[DllImport(user32Dll, CharSet = Win32Charset.BuildCharSet)]
		public static extern IntPtr FindWindowEx(IntPtr hwndParent, IntPtr hwndChildAfter, string lpszClass, string lpszWindow);

		[DllImport(user32Dll, ExactSpelling = true)]
		public static extern bool IsWindowVisible(IntPtr hwnd);

		[DllImport(user32Dll, ExactSpelling = true, CharSet = Win32Charset.BuildCharSet)]
		...
		[DllImport(user32Dll, CharSet = Win32Charset.BuildCharSet, EntryPoint = "GetWindowLongPtr")]
		...
		[SuppressMessage("Microsoft.Interoperability", "CA1400:PInvokeEntryPointsShouldExist")]
		[DllImport(user32Dll, CharSet = Win32Charset.BuildCharSet, EntryPoint = "SetWindowLongPtr")]
