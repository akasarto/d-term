...
{
	/// <summary>
	/// Process option view model interface.
	/// </summary>
	public interface IProcessOptionViewModel
	{
		Guid Id { get; set; }
	...
	/// <summary>
	/// App process option view model implementation.
	/// </summary>
	public class ProcessOptionViewModel : ReactiveObject, IProcessOptionViewModel
	{
		//
		private Guid _id;
